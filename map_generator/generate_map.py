...
def generate_new_map(filename='test.png', coordinates=None, distance=1200):
...
def discover_event_spots(geod):
    ...
    for build in geod['buildings']['geometry']:
        ...
        if random.randint(1,5) == 1:
            houses.append({'event_id':len(houses), 'symbol':'$', 'x':30, 'y':30})
...
def generate_map_and_cities():
    ...
    geo_items = generate_new_map(filename='../static/world_folder/world1/world1_map.png')
